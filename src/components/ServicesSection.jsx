...
//       icon: <Droplet size={40} className="text-blue-600 group-hover:animate-bounce" />,
...
//       icon: <Zap size={40} className="text-blue-600 group-hover:animate-bounce" />,
//       desc: "Ensure your deep freezer stays cool and efficient with our expert repair and maintenance services.",
//     },
//     {
//       title: "Microwave Oven Repair",
//       icon: <Microwave size={40} className="text-blue-600 group-hover:animate-bounce" />,
//       desc: "We fix heating, display, and power issues in all brands of microwave ovens efficiently.",
//     },
//   ];

//   //Handle Modal Open with Selected Service
...
//                 {/* Icon */}
//                 <div className="bg-blue-50 p-4 rounded-full mb-5 transition-transform duration-300 group-hover:scale-110 shadow-sm">
//                   {service.icon}
//                 </div>
...
//                     className="bg-green-500 text-white px-5 py-4 rounded-lg font-medium hover:bg-green-600 hover:scale-105 transition-transform duration-300"
//                   >
//                     WhatsApp
//                   </a>
//                 </div>
...
//     defaultService = {selectedService} // Pass selected service as default
//     />
//     </>
//   );
// }
