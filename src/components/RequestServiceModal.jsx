...
//   //Auto-select service name when modal opens from service card
//   useEffect(() => {
//     if (defaultService) {
...
//         "template_4aratxn", // Replace with your EmailJS template ID
//         formData,
...
//       <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl max-w-md w-full p-8 relative transform scale-95 opacity-0 animate-slideInUp">
//         {/* Close Button */}
//         <button
//           onClick={onClose}
...
//               className="w-full border border-gray-500 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition"
//               required
//             />
//           </div>
...
//               className="w-full border border-gray-500 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition resize-none"
//             ></textarea>
//           </div>
...
//             >
//               <Send size={20} /> {loading ? "Sending..." : "Submit Request"}
//             </button>
